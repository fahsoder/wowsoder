		...
		<div class = 'container-fluid ' style = "overflow: hidden; ">
			<div class="row" >
				...
				<div class="col-md-5">
					...
					<div class="card bg-primary opacity-1">
						<div class="card-body bg-secondary">
							<h5 class="card-title text-light">Evento de Bonus de XP!</h5>         
							<p class="card-text text-light">WoW Soder WoW Soder estará ofertando em todo final de semana, um bonus de XP!</p>      
							<p class="card-text text-light">Data de início: Todos feriados, e finais de semana a partir de sexta-feira às 11:59  |   Data do fim: Sem data final;</p>
						</div>
					</div>
				</div>
				<div class="col-md-3">
