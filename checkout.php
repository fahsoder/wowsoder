    ...
    <div class = 'container-fluid text-center' style = "overflow: hidden;">
        <div class = "row text-center">
            ...
            <div class = "col-md-6">
                ...
                <div class="jumbotron col-lg-15 text-center" style="position: relative; background: none">
                    <form class="form-check-inline" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="MFMGBBN7X9ZKG">
						<table class="form-group">
							<tr class="form-group">
								<td class="form-group text-center">
									<label class="control-label border-2 text-center" for="email" ><h3>Armaduras de Doação para Guerreiros!</h3></label>
								</td>
							</tr>
							<tr class="form-group">
								<td class="form-group text-center">
									<label class="control-label border-2 text-center" for="email" ><h4></h4></label>
								</td>
							</tr>
							<tr class="form-group">
								<td class="form-group text-center">
							...
							<tr class="form-group">
								<td class="form-group text-center">
									<label class="control-label border-2 text-center" for="email" >Selecione o item desejado:</label>
									<input class="control-label border-2 text-center" type="hidden" name="on0" value="Selecione o item">
								</td>
							</tr>
							<tr class="form-group">
								<td class="form-group text-center">
							...
							<tr class="form-group">
								<td class="form-group text-center">
									<label class="control-label border-2" for="email" >Selecione a especialização:</label>
									<input type="hidden" name="on1" value="Selecione a especialização">
								</td>
							</tr>
							<tr class="form-group">
								<td class="form-group text-center">
									<select class="form-control" name="os1">
							...
							<tr class="form-group">
								<td class="form-group text-center">
									<label class="control-label border-2" for="email" >Digite o nome do personagem:</label>
									<input type="hidden" name="on2" value="Digite o nome do personagem">
								</td>
							</tr>
							<tr class="form-group">
								<td class="form-group text-center">
