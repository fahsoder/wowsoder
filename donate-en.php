        ...
        <div style="background: url(img/world-of-warcraft-Wrath-of-the-Lich-King-wallpaper.jpg) no-repeat bottom center scroll;
                ...
                <div class = "row">
                    <div class = "col-lg-4 col-lg-offset-4">
                        <div class="jumbotron text-center" style = "margin-top:-12%; margin-bottom:25%;">
                            <form class="form-horizontal" action="cadastro.php" method="POST">
                                <div>
                                    <h3 style="text-align: center ">Donates</h3>
                                </div>
                                <div>
                                    <p style="text-align: center ">This page is still being developing...</p>
								</div>
                            </form> 
